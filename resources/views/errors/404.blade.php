...
<?php
$world['1']="Artık demir almak günü gelmişse zamandan,
                   Meçhule giden bir gemi kalkar bu limandan.";

$world['2']="Sokaktayım, kimsesiz bir sokak ortasında;
                   Yürüyorum, arkama bakmadan yürüyorum.";

$world['3']="Şu Boğaz Harbi nedir? Var mı ki dünyâda eşi?
                   En kesîf orduların yükleniyor dördü beşi,";

$world['4']="Anılar defterinde gül yaprağı Gibi unutuldum kurudum
                   Başıma düşmüş sevda ağı Bir başıma tenhalarda kahroldum";

$world['5']="Ben yürürüm yane yane Aşk boyadı beni kane
...
<div class="container">
    ...
    <div class="warning">
        <h2>"{{ $world[$rastgele] }}"</h2>
        <p>Aradığınız sayfa bulunamadı, sayfa değiştirilmiş yada kaldırılmış olabilir!</p>
        <a href="javascript:history.back()">Lütfen Bir Önceki Sayfa Dönünüz!</a>
    </div>

    <div class="footer"><p class="copyright">&copy;
            {{ date('Y')  }}
            denizlisosyaluyum.org</p></div>
